...
<div id="app"><br>
    <el-row :gutter="20">
        <el-col :span="8">
            <div class="grid-content bg-purple" style="max-width:100px;height: 1px;"></div>
        </el-col>
            ...
            <div class="grid-content bg-purple">
                ...
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <div v-show="sliderShow">
                        <div class="block">
                            <span class="demonstration">请将滑块移动到<span
                                    style="color: red;">{{resultValue}}</span>以通过校验</span><br>
