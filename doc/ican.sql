...
CREATE TABLE `auth_photo` (
  ...
  `type` tingint(2) UNSIGNED NOT NULL COMMENT '角色,0-未定义，1-超级管理员，2-普通管理员，3-学校账号,4-二级学院账号，5-导师账号，6-学生账号',
...
CREATE TABLE `file` (
  ...
  `entity_type` tinyint(2) UNSIGNED NOT NULL  default '0' COMMENT '类型（0-未知,1-学校,2-二级学院,3-导师,4-学生,5-课题,6-task,7-博客,8-聊天文件）',
